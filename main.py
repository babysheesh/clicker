...
def start_screen():
    ...
    fon = pygame.transform.scale(load_image('111.jpg'), (1920, 1080))
    screen.blit(fon, (0, 0))
...
def main_loop():
    ...
    while game_running:
        ...
        DrawText(f"Боковые кнопки мыши(+{uup1 * voz})", black, light_blue, 485, 27, 20)
        DrawText("Цена:" + str(int(ccost1)), black, light_blue, 70, 27, 20)
        DrawText(f"Еда(+{uup2 * voz})", black, light_blue, 390, 87, 20)
        DrawText("Цена:" + str(int(cсost2)), black, light_blue, 70, 87, 20)
        DrawText(f"Колонки(+{uup3 * voz})", black, light_blue, 400, 147, 20)
        DrawText("Цена:" + str(int(cсost3)), black, light_blue, 70, 147, 20)
        DrawText(f"Наушники(+{uup4 * voz})", black, light_blue, 410, 207, 20)
        ...
        DrawText(f"Наушники(+{uup6 * voz})", black, light_blue, 410, 327, 20)
        DrawText("Цена:" + str(int(cсost6)), black, light_blue, 70, 327, 20)
        DrawText(f"Наушники(+{uup7 * voz})", black, light_blue, 410, 387, 20)
        DrawText("Цена:" + str(int(cсost7)), black, light_blue, 70, 387, 20)
        DrawText(f"Наушники(+{uup8 * voz})", black, light_blue, 410, 443, 20)
        DrawText("Цена:" + str(int(cсost8)), black, light_blue, 70, 443, 20)
        DrawText(f"Наушники(+{uup9 * voz})", black, light_blue, 410, 503, 20)
        DrawText("Цена:" + str(int(cсost9)), black, light_blue, 70, 503, 20)
        DrawText(f"Наушники(+{uup10 * voz})", black, light_blue, 410, 563, 20)
